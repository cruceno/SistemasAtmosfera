        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	...
        	<form id="plotForm" class="form-horizontal">
        	  ...
        	  <div class="form-group col-sm-4 col-md-4">
        	    <label class="control-label" for="d1">Canales</label>
        	    <select  required name="channels_to_plot[]" id="ChannelsToPlot" multiple class="form-control">
        	  ...
        	  <div class="form-group col-sm-4 col-md-4">
			    ...
			    <input type="date" class="form-control" required id="d1" name="d1" min="2016-02-03"  pattern="(?:201)[0-9]{1}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" placeholder="YYYY-MM-DD">

			    <label class=" control-label" for="d2">Ingrese limite superior</label>
			    <input type="date" class="form-control" required min="2016-02-04" id="d2" name="d2" pattern="(?:201)[0-9]{1}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" placeholder="YYYY-MM-DD">
			  </div>
			  <div class="form-group col-sm-4 col-md-4">
			    <button id="plot" type="submit" class="btn-lg btn-primary btn-block">Graficar</button>
			  </div>    
        	</form>
        	</div>
        	<div id="flot-chart" style="height:350px;" class="col-sm-9 col-md-9"></div>
