...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div
				class="tab-content col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
     	      ...
     	      <?php $channels=get_channels_config(Null); ?>
       	      <thead>
								<tr>
									<th>Fecha <br>
									<small>(YYYY-MM-DD HH:mm:ss)</small></th>
      	     		<?php
				...
				<div id=analisis role="tabpanel" class="tab-pane fade"></div>
				...
				<div id=exportar role="tabanel" class="tab-pane fade">
					...
					<form class="form-horizontal" name="export" id="export">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="d1">Ingrese limite
								inferior</label>
							<div class="col-sm-4">
								...
								<p class="help-block">En el caso de Internet Explorer y Firefox
									el formato debe ser YYYY-MM-DD, respetando cantidad de digitos
									y guiones medios. La fecha no puede ser inferior al 2016-02-03</p>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="d2">Ingrese limite
								superior</label>
							<div class="col-sm-4">
								<input type="date" class="form-control" min="2016-02-04"
									name="d2"
									pattern="(?:201)[0-9]{1}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"
									placeholder="YYYY-MM-DD">
								<p class="help-block">En el caso de Internet Explorer y Firefox
